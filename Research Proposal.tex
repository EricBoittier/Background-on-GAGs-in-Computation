...
\begin{tabular}{p{5em}p{14em}p{17em}} \hline \hline
    ...
    \vspace{0.01mm}\hspace{5mm}\includegraphics[width=4cm]{structures/HepSNFG.jpg}
    ...
    \hspace{5mm}\includegraphics[width=4cm]{structures/HSSNFG.jpg}
...
%         \includegraphics[width=5.5cm]{structures/examplePHIimage.jpg}
%         \caption{phi (\textphi)}
%     \end{subfigure}
%     \begin{subfigure}[b]{0.3\textwidth}
%         \includegraphics[width=5.5cm]{structures/examplePSIimage.jpg}
%         \caption{psi (\textpsi)}
%     \end{subfigure}
    
%     \caption{Example of phi (\textphi) and psi (\textpsi) dihedral angles using the crystallographic definition.}
%     \label{fig:phipsi}
% \end{figure}
}
